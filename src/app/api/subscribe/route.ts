/**
 * Endpoint API para registrar suscriptores.
 * Incluye verificación básica y envío de notificación por email.
 */
import { NextRequest, NextResponse } from 'next/server';
import { addSubscriber, Subscriber } from '../../../services/subscribers';
