...
/**
 * Página para renderizar el contenido MDX de una edición concreta.
 * Carga dinámicamente el archivo según el parámetro de la ruta.
 */
...
export default function Page({ params }: { params: { edition: string } }) {
  ...
  // Carga dinámica del archivo MDX correspondiente
  useEffect(() => {
